...
#        --data_basedir D:\data\mmeb_v2\image-tasks
    python3 src/evaluation/mmeb_v2/eval_embedding.py --normalize true --per_device_eval_batch_size 16  --model_name_or_path "Qwen/Qwen3-VL-Embedding-8B" --dataset_config "scripts/evaluation/mmeb_v2/image_tmp.yaml" --encode_output_path "results/evaluation/mmeb_v2/Qwen3-VL-Embedding-8B/tmp/"  --output_dir "results/evaluation/mmeb_v2/Qwen3-VL-Embedding-8B/tmp/" --data_basedir "D:\data\mmeb_v2" --vllm_api_url http://192.168.9.146:9090/v1
